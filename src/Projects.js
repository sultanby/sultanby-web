                ...
                <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
                    ...
                    <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
                        <div className="group relative">
                            ...
                            <p className="text-base font-semibold text-gray-900">TONRunner</p>
                        ...
                        <div className="group relative">
                            ...
                            <p className="text-base font-semibold text-gray-900">CROLUX</p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <span class="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl">
                                    TypeScript
                                </span>
                        ...
                        <div className="group relative">
                            ...
                            <p className="text-base font-semibold text-gray-900">minireddit</p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <span class="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl">
                                    Redux-Thunk
                                </span>
                    ...
                    <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
                        <div className="group relative">
                            ...
                            <p className="text-base font-semibold text-gray-900">jammming</p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <span class="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl">
                                    Spotify API
                                </span>
                        ...
                        <div className="group relative">
                            ...
                            <p className="text-base font-semibold text-gray-900">flashcards</p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <span class="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl">
                                    React
                                </span>
                        ...
                        <div className="group relative">
                            ...
                            <h3 className="mt-6 text-sm text-gray-500">
                                <a href="https://sultanby.github.io/table_tennis_club/">
                                    <span className="absolute inset-0"></span>
                                    Table tennis club web
                                </a>
                            </h3>
                            <p className="text-base font-semibold text-gray-900">bingbong</p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <span class="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl">
                                    HTML
                                </span>
